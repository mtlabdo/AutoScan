                ...
                it.copy(
                    settingCards =
                        listOf(
                            CardUiState(
                                id = 1,
                                R.drawable.ic_langue,
                                R.string.language_card_title,
                                null,
                                null,
                            ),
                            CardUiState(
                                id = 3,
                                R.drawable.ic_dark_light,
                                R.string.dark_mode_card_title,
                                null,
                                null,
                            ),
                            CardUiState(
                            ...
                            CardUiState(
                                ...
                                R.string.privacy_policy_card_title,
                                null,
                                null,
                            ),
                            CardUiState(
                                id = 6,
                                R.drawable.ic_term,
                                R.string.terms_of_service_card_title,
                                null,
                                null,
                            ),
                            CardUiState(
                                id = 7,
                                R.drawable.ic_term_use,
                                R.string.terms_of_use_card_title,
                                null,
                                null,
                            ),
                        ),
